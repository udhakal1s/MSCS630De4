// MSCSDe4.java
// Integrated shell implementation for D1–D4
// Author: generated for user (Umesh)
import java.io.*;
import java.util.*;
...
public class MSCSDe4 {
    ...
    public static void main(String[] args) throws Exception {
        // Create user Umesh
        users.put("umesh", new User("umesh","umesh56","admin"));
        filePerms.put("/etc/system.cfg","r--");
        filePerms.put("data.txt","rw-");
        if(!authenticate()) return;
        System.out.println("Welcome to MSCS630 shell");
    ...
    static String builtin_rm(String[] t){ if(t.length<2) return ""; try{ Files.delete(Paths.get(t[1])); return ""; }catch(Exception e){return "rm error\n";}}
    ...
    static String cmd_access_page(String[] t){
